...
u16 gpio_init_mode_data[] = {
    ...
    ((GPIO165_MODE    <<  0) |(GPIO166_MODE    <<  3) |(GPIO167_MODE    <<  6) |(GPIO168_MODE    <<  9)),
...
void mt_gpio_set_default_chip(void)
{
	...
	/* for msdc */
	mt_set_gpio_pull_enable(GPIO114, GPIO114_PULLEN);
	mt_set_gpio_pull_enable(GPIO115, GPIO115_PULLEN);
	mt_set_gpio_pull_enable(GPIO116, GPIO116_PULLEN);
	mt_set_gpio_pull_enable(GPIO117, GPIO117_PULLEN);
	mt_set_gpio_pull_enable(GPIO118, GPIO118_PULLEN);
	mt_set_gpio_pull_enable(GPIO119, GPIO119_PULLEN);

	mt_set_gpio_pull_select(GPIO114, GPIO114_PULL);
	mt_set_gpio_pull_select(GPIO115, GPIO115_PULL);
	mt_set_gpio_pull_select(GPIO116, GPIO116_PULL);
	mt_set_gpio_pull_select(GPIO117, GPIO117_PULL);
	mt_set_gpio_pull_select(GPIO118, GPIO118_PULL);
	...
	mt_set_gpio_pull_enable(GPIO127, GPIO127_PULLEN);
	mt_set_gpio_pull_enable(GPIO128, GPIO128_PULLEN);
	mt_set_gpio_pull_enable(GPIO129, GPIO129_PULLEN);
	...
	mt_set_gpio_pull_select(GPIO127, GPIO127_PULL);
	mt_set_gpio_pull_select(GPIO128, GPIO128_PULL);
	mt_set_gpio_pull_select(GPIO129, GPIO129_PULL);
