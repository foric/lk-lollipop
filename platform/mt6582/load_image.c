...
static int mboot_android_check_bootimg_hdr(part_dev_t *dev, char *part_name, boot_img_hdr *boot_hdr)
{
    ...
    printf("[%s] Android Boot IMG Hdr - Kernel Size 	: 0x%08X\n",MODULE_NAME,boot_hdr->kernel_size);
    printf("[%s] Android Boot IMG Hdr - Kernel Address 	: 0x%08X\n",MODULE_NAME,boot_hdr->kernel_addr);
    printf("[%s] Android Boot IMG Hdr - Rootfs Size 	: 0x%08X\n",MODULE_NAME,boot_hdr->ramdisk_size);
    printf("[%s] Android Boot IMG Hdr - Rootfs Address 	: 0x%08X\n",MODULE_NAME,boot_hdr->ramdisk_addr);
    printf("[%s] Android Boot IMG Hdr - Tags Address 	: 0x%08X\n",MODULE_NAME,boot_hdr->tags_addr);
    printf("[%s] Android Boot IMG Hdr - Page Size    	: 0x%08X\n",MODULE_NAME,boot_hdr->page_size);    
    printf("[%s] Android Boot IMG Hdr - Command Line    : %s\n"  ,MODULE_NAME,boot_hdr->cmdline);
	printf("============================================================\n");
...
static int mboot_android_check_recoveryimg_hdr(part_dev_t *dev, char *part_name, boot_img_hdr *boot_hdr)
{
    ...
    printf("[%s] Android Recovery IMG Hdr - Kernel Size 	: 0x%08X\n",MODULE_NAME,boot_hdr->kernel_size);
    printf("[%s] Android Recovery IMG Hdr - Kernel Address 	: 0x%08X\n",MODULE_NAME,boot_hdr->kernel_addr);
    printf("[%s] Android Recovery IMG Hdr - Rootfs Size 	: 0x%08X\n",MODULE_NAME,boot_hdr->ramdisk_size);
    printf("[%s] Android Recovery IMG Hdr - Rootfs Address 	: 0x%08X\n",MODULE_NAME,boot_hdr->ramdisk_addr);
    printf("[%s] Android Recovery IMG Hdr - Tags Address 	: 0x%08X\n",MODULE_NAME,boot_hdr->tags_addr);
    printf("[%s] Android Recovery IMG Hdr - Page Size    	: 0x%08X\n",MODULE_NAME,boot_hdr->page_size);    
    printf("[%s] Android Recovery IMG Hdr - Command Line    : %s\n"  ,MODULE_NAME,boot_hdr->cmdline);
	printf("============================================================\n");
...
static int mboot_android_check_factoryimg_hdr(char *part_name, boot_img_hdr *boot_hdr)
{
 ...
 //   ulong addr;
    ...
    printf("[%s] Android Factory IMG Hdr - Kernel Size 	    : 0x%08X\n",MODULE_NAME,boot_hdr->kernel_size);
    printf("[%s] Android Factory IMG Hdr - Kernel Address 	: 0x%08X\n",MODULE_NAME,boot_hdr->kernel_addr);
    printf("[%s] Android Factory IMG Hdr - Rootfs Size 		: 0x%08X\n",MODULE_NAME,boot_hdr->ramdisk_size);
    printf("[%s] Android Factory IMG Hdr - Rootfs Address 	: 0x%08X\n",MODULE_NAME,boot_hdr->ramdisk_addr);
    printf("[%s] Android Factory IMG Hdr - Tags Address 	: 0x%08X\n",MODULE_NAME,boot_hdr->tags_addr);
    printf("[%s] Android Factory IMG Hdr - Page Size    	: 0x%08X\n",MODULE_NAME,boot_hdr->page_size);
    printf("[%s] Android Factory IMG Hdr - Command Line    	: %s\n"  ,MODULE_NAME,boot_hdr->cmdline);
	printf("============================================================\n");
...
#else
	start_addr = part->startblk * BLK_SIZE + g_boot_hdr->page_size;
#endif
...
//	unsigned long begin;
    ...
    // check ramdisk/rootfs header
    g_rimg_sz = mboot_android_check_img_info(PART_RECOVERY, (part_hdr_t *)g_rmem_off);
    if (g_rimg_sz == -1) {
